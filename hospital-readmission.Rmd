...
#### Remove the HCAHPS average star rating variables and leave the linear score variables. 
```{r}
# Remove all the average patient survey star rating variables
columns_to_remove <- c(
...
# Print columns to verify it worked
print("Columns left after removing average star rating variables")
print(colnames(HipKneeTrain))

# Linear mean scores encompass all survey response categories in each HCAHPS measure and are converted and combined into a 0-100 linear-scaled measure score.
```
