...
# 7. Visualize feature distributions across clusters
# Let's take a few important features as an example
features_to_plot <- c("PredictedReadmissionRate_HIP_KNEE", "HcahpsLinearMeanValue_H_HSP_RATING_LINEAR_SCORE", "Score_COMP_HIP_KNEE", "Payment_PAYM_90_HIP_KNEE", "SAFE_USE_OF_OPIOIDS")

for (feature in features_to_plot) {
  p <- ggplot(HipKneeTrain, aes_string(x = "Cluster", y = feature, fill = "Cluster")) +
    geom_boxplot() +
    theme_minimal() +
