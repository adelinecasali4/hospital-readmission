...
cluster_plot <- fviz_cluster(kmeans_result, data = X_scaled,
  ...
  labs(title = "Figure 4. K-Means Clustering Results")
...
fviz_cluster(list(data = pca_plot_data, cluster = hc_clusters),
             ...
             palette = "jco",
             ggtheme = theme_minimal(),
             main = "Figure 5. Hierarchical Clustering Results (PCA)")
```
...
ggplot(data = NULL, aes(x = residuals_rf)) +
  ...
  labs(title = "Figure 6. Histogram of Residuals",
       x = "Residuals",
       y = "Frequency") +
  theme_minimal()

# QQ plot of residuals
qqnorm(residuals_rf, main = "Figure 7. QQ Plot of Residuals")
